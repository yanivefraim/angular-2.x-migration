...
System.register("tree/some!tree/plugin", [], false, function(__require, __exports, __module) {
  System.get("@@global-helpers").prepareGlobal(__module.id, []);
  (function() {
    [];
  }).call(System.global);
...
System.register("tree/component.jsx!tree/jsx", [], true, function(require, exports, module) {
  var global = System.global,
      __define = global.define;
  global.define = undefined;
  var React = {};
  ...
  exports.component = React.createElement("div", {className: "foo"});
  global.define = __define;
  return module.exports;
});
...
System.register("tree/first", ["@empty", "tree/second", "tree/amd", "tree/component.jsx!tree/jsx"], function($__export) {
  "use strict";
  ...
  return {
    ...
    execute: function() {
      p = $__export("p", 5);
      test = $__export("test", (function() {
        var test = function test() {
          $traceurRuntime.superConstructor(test).call(this);
        };
